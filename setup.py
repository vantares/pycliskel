...
.. moduleauthor:: Juan C. Alvarez <alvarezvelez.juancarlos@gmail.com>
"""
...
setup(
    name='pycliskel',
    description="python command line project skeleton",
    ...
    entry_points="""
    [console_scripts]
    pycliskel=pycliskel.cli:cli
    """,
    python_requires=">=0.0.1",
    license=None,  # noqa
    author='Juan C. Alvarez',
    author_email='alvarezvelez.juancarlos@gmail.com',
    # Use the URL to the github repo.
    url= 'https://github.com/vantares/pycliskel',
    download_url=(
        f'https://github.com/vantares/'
        f'pycliskel/archive/{version}.tar.gz'
    ),
    keywords=[
